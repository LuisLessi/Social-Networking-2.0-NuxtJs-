...
<div class="page-wrapper">
    ...
    <div class="nav-wrapper">
     ...
     <nav class="navbar">
      <NuxtLink to="/home"><img src="../assets/SocialNet_logo.svg.png" alt="Company Logo"></NuxtLink>
    ...
    <div class="anim-container" id="anim_container">
       ...
       <h2>Grupos: Navegue pelos grupos para compartilhar ideias</h2>
       <br>
       <h2>Feed: Veja as ultimas postagens de vagas ou de perfis que você segue</h2>


      </div>
      <div class="center">
      <a href="/feed"><button class="btn">
        <svg width="180px" height="60px" viewBox="0 0 180 60" class="border">
          <polyline points="179,1 179,59 1,59 1,1 179,1" class="bg-line" />
          <polyline points="179,1 179,59 1,59 1,1 179,1" class="hl-line" />
        </svg>
        <span>Meu Feed<br>⬤</span>
      </button></a>
...
.grad-bar {
	width: 100%;
	height: 5px;
	background: linear-gradient(95deg, #00ff88, #E73C7E, #23A6D5, #23D5AB);
